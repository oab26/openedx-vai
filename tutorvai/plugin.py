...
if (process.env.APP_ID === 'learner-dashboard') {
  (function() {
    ...
    style.textContent = [
      ...
      "html header.site-header-mobile button { background: transparent !important; border: 1.5px solid #490B8A !important; color: #490B8A !important; border-radius: 50% !important; width: 40px !important; height: 40px !important; padding: 0 !important; display: flex !important; align-items: center !important; justify-content: center !important; }",
      "html header.site-header-mobile button svg { color: #490B8A !important; fill: #490B8A !important; }",
      "html header.site-header-mobile button .avatar { display: none !important; }",
